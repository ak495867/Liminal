...
for observed_at, content in (
    (
        first,
        "The archive project launched in 2024 and preserves public source changes.",
    ),
    (
        second,
        "The archive project launched in 2025 and preserves public source changes with uncertainty labels.",
    ),
):
